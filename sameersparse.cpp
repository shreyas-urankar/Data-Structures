////Q2 ) Accept conventional matrix and convert it into sparse matrix using structure and perform addition
////
////Program :- 
//
//
...
//    cout<<"Enter number of rows in 1st sparse matrix :- ";
//    cin>>row1;
